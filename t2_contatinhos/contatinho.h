...
int inserir(t_avl *avl, t_elemento elemento);//insere novos contatos
int pesquisar(t_avl *avl, t_chave nome);//devolve a posição buscada
int remover(t_avl *avl, t_chave nome);//remove contatos já existentes
int alterar(t_avl *avl, t_elemento novo);//altera o contato encontrado
